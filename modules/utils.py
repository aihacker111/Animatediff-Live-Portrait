...
def video_to_high_fps(output_name, video_file_path, audio_path, processed_file_save_dir, time_interval, fps_ffmpeg,
                      crf=17, ffmpeg_path='/usr/bin/ffmpeg'):
    """
...
def match_colors(input_frames, ref_frame):
    ...
    for frame in input_frames:
        ...
        img_res = cm.transfer(src=frame, ref=img_ref,
                              method='hm-mkl-hm')  # 'default', 'hm', 'reinhard', 'mvgd', 'mkl', 'hm-mvgd-hm', 'hm-mkl-hm'
