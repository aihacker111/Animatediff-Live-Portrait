        ...
        with gr.Column(variant="panel"):
            ...
            with gr.Column(visible=False) as controlnet_column:
                with gr.Row():
                    ...
                    controlnet_processor_path_refresh_button.click(fn=update_videos, inputs=[],
                                                                   outputs=[controlnet_processor_path_dropdown])
                ...
                with gr.Row():
                    ...
                    controlnet_conditioning_scale_slider = gr.Slider(label="Controlnet strenth", value=0.5, minimum=0.1,
                                                                     maximum=1.0, step=0.1)
